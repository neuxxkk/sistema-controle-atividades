  ...
  return (
    <>
      ...
      <div className="p-8 max-w-[1200px] mx-auto w-full">
        <div className="bg-[var(--superficie-1)] border border-[var(--borda-padrao)] rounded-md p-8">
           ...
           <div className="flex flex-col gap-6">
              <div className="flex items-center justify-between border-b border-[var(--cinza-100)] pb-4">
                 <div>
                    ...
                    <p className="text-xs text-[var(--texto-secundario)]">Ativar interface com cores escuras (opcional)</p>
                  </div>
                  <div className="w-10 h-5 bg-[var(--cinza-300)] rounded-full relative">
                     <div className="absolute left-1 top-1 w-3 h-3 bg-[var(--superficie-0)] rounded-full"></div>
                  </div>
               </div>
              ...
              <div className="flex items-center justify-between border-b border-[var(--cinza-100)] pb-4">
                 <div>
                    ...
                    <p className="text-xs text-[var(--texto-secundario)]">Alertas sonoros ao finalizar atividades</p>
                  </div>
                  <div className="w-10 h-5 bg-[var(--verde-principal)] rounded-full relative">
                     <div className="absolute right-1 top-1 w-3 h-3 bg-[var(--superficie-0)] rounded-full"></div>
                  </div>
               </div>
           </div>
        </div>
